...
lockstyle_cmd = string.format("lua l dressup; input /lockstyleset %s; gs equip sets.idle; du blinking %s;", tonumber(LOCKSTYLE or 200), tostring(DRESSUP[player.main_job] or "self all off"))